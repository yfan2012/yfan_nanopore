...
if __name__ == '__main__':
    ...
    parser.add_argument('--asmfile', '-i', type=str, required=True, help='asm to be broken')
    parser.add_argument('--npbamfile', '-s', type=str, required=True, help='nanopore reads aligned to asm')
    parser.add_argument('--illbamfile', '-r', type=str, required=True, help='illumina reads aligned to asm')
    parser.add_argument('--regionfile', '-m', type=int, required=True, help='zero cov regions as generated by the R script')
