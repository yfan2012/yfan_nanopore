...
if [ $1 == canu_pilon_trim ] ; then
    ...
    sbatch --output=$datadir/batch_logs/bird_pilon.out --job-name=bird ./pilon.scr $datadir/bird_canu_pilon_trim $datadir/bird_assembly/bird.contigs.fasta bird canu
    sbatch --output=$datadir/batch_logs/patient_pilon.out --job-name=patient ./pilon.scr $datadir/patient_canu_pilon_trim $datadir/patient_assembly/patient.contigs.fasta patient canu
fi
